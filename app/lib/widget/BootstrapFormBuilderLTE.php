 ...
 */
class BootstrapFormBuilderLTE implements AdiantiFormInterface
{
    private $decorated;
    private $tabcontent;
    private $tabcurrent;
    ...
    public function __construct($name = 'my_form')
    {
        ...
        $this->classbox = 'box box-primary';
        $this->classheader = 'box-header with-border';
        $this->classbody = 'box-body';
        $this->classfooter = 'box-footer';
        $this->classtitle = 'panel-title';
    ...
    public function addQuickField(){
        
    }
    public function addQuicAction($label, TAction $action, $icon = 'fa:save'){
        $this->addAction($label, $action, $icon);
    }
    ...
    public function show()
    {
        ...
        $heading->{'class'} = $this->classheader;
        $heading->{'style'} = 'width: 100%';
        //$heading->add(TElement::tag('div', $this->title, ['class'=>'panel-title']));
        $heading->add(TElement::tag('div', $this->title, ['class' => $this->classtitle]));
