 ...
 */
class ListCatalogo extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_search_BlogCatalogo');
        ...
        $this->form->setData(TSession::getValue('BlogCatalogo_filter_data'));

        // add the search form actions
        $this->form->addQuickAction(_t('Find'), new TAction(array($this, 'onSearch')), 'fa:search');
        $this->form->addQuickAction(_t('New'), new TAction(array('FormCatalogo', 'onEdit')), 'bs:plus-sign green');
        ...
        // define columns
        $column_idcatalogo = new TDataGridColumn('id', 'ID', 'left');
        $this->datagrid->addColumn($column_idcatalogo);
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormCatalogo', 'onEdit'));
        ...
        $panel = new TPanelGroup('Artículos');
        $panel->add($this->form);
    ...
    public function onReload($param = null)
    {
        try
        {
            ...
            $repository = new TRepository('BlogCatalogo');
            $limit = 10;
            // creates a criteria
    ...
    public function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('database'); // open a transaction with database
            $object = new BlogCatalogo($key, false); // instantiates the Active Record
