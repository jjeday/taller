...
class FormUs extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_BlogUs');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormBuilder('form_BlogUs');
        ...
        $list = $this->form->addAction(_t('List'), new TAction(array('ListUs', 'onLoad')), 'bs:list');
    ...
    public function onSave($param)
    {
        try
        {
            ...
            $object = (empty($data->id)) ? new BlogUs : new BlogUs($data->id, true); // create an empty object
