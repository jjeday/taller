 ...
 */
class FormProduct extends TPage
{
    protected $form; // form
    ...
    public function __construct($param)
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_BlogProduct');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormBuilder('form_BlogProduct');
        $this->form->style = 'display: table;width:100%'; // change style
        //$this->form->setFieldsByRow(1);

        // define the form title
        $this->form->setFormTitle('Catalogo (productos)');
        ...
        */
        ...
        $categoria_id = new TDBCombo('idcategory', 'database', 'BlogCategory', 'id', 'name', 'name', $criteria);
        //TDBCombo($name, $database, $model, $key, $value, $ordercolumn = NULL, TCriteria $criteria = NULL);
        ...
        $trademark->setTip('La marca del producto');
        $measure->setTip('Poner las medidas largo x ancho x alto cm');
        ...
        $this->form->addFields([new TLabel('Marca')], [$trademark]);
        $this->form->addFields([new TLabel('Modelo')], [$model]); //
        $this->form->addFields([new TLabel('Medidas')], [$measure]); //
        ...
        $list = $this->form->addAction(_t('List'), new TAction(array('ListProduct', 'onLoad')), 'bs:list');
    ...
    public function onSave($param)
    {
        try
        {
            ...
            $object = (empty($data->id)) ? new BlogProduct : new BlogProduct($data->id, true); // create an empty object
