 ...
 */
class FormSupplier extends TPage
{
    protected $form; // form
    ...
    public function __construct($param)
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_BlogSupplier');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormBuilder('form_BlogSupplier');
        ...
        $name->setTip('Nombre del proveedor');
        ...
        $list = $this->form->addAction(_t('List'), new TAction(array('ListSupplier', 'onLoad')), 'bs:list');
    ...
    public function onSave($param)
    {
        try
        {
            ...
            $object = (empty($data->id)) ? new BlogSupplier : new BlogSupplier($data->id, true); // create an empty object
