 ...
 */
class ListCategory extends TPage
{
    private $form; // form
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_search_BlogCategory');
        ...
        $this->form->setData(TSession::getValue('BlogCategoria_filter_data'));

        // add the search form actions
        $this->form->addQuickAction(_t('Find'), new TAction(array($this, 'onSearch')), 'fa:search');
        $this->form->addQuickAction(_t('New'), new TAction(array('FormCategory', 'onEdit')), 'bs:plus-sign green');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormCategory', 'onEdit'));
        ...
        $panel = new TPanelGroup('Categorías');
        $panel->add($this->form);
    ...
    public function onReload($param = null)
    {
        try
        {
            ...
            $repository = new TRepository('BlogCategory');
            $limit = 10;
            // creates a criteria
    ...
    public function Delete($param)
    {
        try
        {
            ...
            TTransaction::open('database'); // open a transaction with database
            $object = new BlogCategory($key, false); // instantiates the Active Record
